...
public class Security extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/api/participants/**").hasAnyAuthority("admin","assistant","formateur","commercial")
		...
		.antMatchers("/api/contacts/**").hasAnyAuthority("admin","participant")
		...
		.antMatchers("/api/paiements/**").hasAnyAuthority("admin","assistant")
		.antMatchers("/api/prospoects/**").hasAnyAuthority("admin","commercial")
